...
pca_df = pd.DataFrame(data=principal_components, columns=principal_components_colnames)
pca_df_classes = pd.concat([pca_df, fingerprint_df["bioactivity_class"]], axis=1)
expl_var = pca.explained_variance_ratio_
print("\nPrincipal components explained variance: ", expl_var, "\n")
print("Principal components total explained variance: ", expl_var.sum(), "\n")
...
plt.grid(True)
plt.savefig(
    f"{results_path}/scree_plot-{n_components}_components.svg", bbox_inches="tight"
)
