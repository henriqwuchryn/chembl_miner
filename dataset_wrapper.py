...
class DatasetWrapper:
    ...
    def load_unsplit_csv(
        self, file_path, general_columns, target_column, test_size=0.2, random_state=42
    ):
        """
    ...
    def load_raw_dataset(
        file_path, general_columns, target_column, test_size=0.2, random_state=42
    ):

        instance = DatasetWrapper()
        instance.load_unsplit_csv(
            file_path, general_columns, target_column, test_size=0.2, random_state=42
        )
        return instance
